...
export const RedirectConfirmationModal: React.FunctionComponent<
        ...
        >
          <div
            className={clsx(
              ...
              type === 'intermediate' &&
                'bg-blue-50 bg-opacity-70 text-employment-blue',
              className,
            )}
          >
            ...
            <div className="relative bg-white text-sm">
              <p className="w-full max-w-[361px] px-8 py-5 text-neutral-500">
                You can either go back to change the number or proceed with it.
            ...
            <div className="flex gap-4 p-8">
              <button
                type="button"
                className={clsx(
                  'focus:ring-wise-purple w-full space-x-2 rounded-lg px-6 py-4 text-center text-base font-medium text-white transition duration-500 ease-in-out hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-opacity-30 focus:ring-offset-2 focus:ring-offset-white active:scale-[0.95] disabled:scale-100 disabled:cursor-not-allowed disabled:opacity-60',
                  type === 'success' &&
                    'hover:bg-green-10 bg-green-700 focus:ring-green-500',
                  type === 'error' &&
                    'hover:bg-red-10 bg-red-700 focus:ring-red-500',
                  type === 'intermediate' &&
                    'hover:bg-red-10 bg-employment-blue-light focus:ring-blue-500',
                )}
                onClick={closeModal}
              >
                Return to form
              ...
              <button
                type="button"
                className={clsx(
                  'focus:ring-wise-purple-light w-full space-x-2 rounded-lg px-6 py-4 text-center text-base font-medium text-white transition duration-500 ease-in-out hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-opacity-30 focus:ring-offset-2 focus:ring-offset-white active:scale-[0.95] disabled:scale-100 disabled:cursor-not-allowed disabled:opacity-60',
                  type === 'success' &&
                    'hover:bg-green-10 bg-green-700 focus:ring-green-500',
                  type === 'error' &&
                    'hover:bg-red-10 bg-red-700 focus:ring-red-500',
                  type === 'intermediate' &&
                    'hover:bg-red-10 bg-employment-blue focus:ring-blue-500',
                )}
                onClick={redirect}
              >
                Proceed with number
